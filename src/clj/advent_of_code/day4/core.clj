(ns advent-of-code.day4.core
  (:require [clojure.test :refer [deftest is run-tests]]
            [advent-of-code.day4.part1 :as part1]
            [advent-of-code.day4.part2 :as part2]))

;; https://adventofcode.com/2020/day/4

(def example-batch-file "ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
(def example-batch-file-invalid "eyr:1972 cid:100
...
(def example-batch-file-valid "pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
...
(def puzzle-input "hcl:#6b5442 ecl:brn iyr:2019
...
;; part 1
(deftest part1-test
  (is (= (part1/run example-batch-file) 2)))

;; part 2
(deftest part2-test-invalid
  (is (= (part2/run example-batch-file-invalid) 0)))

(deftest part2-test-valid
  (is (= (part2/run example-batch-file-valid) 4)))

(defn main []
  (println "part1 solution" (part1/run puzzle-input))
  (println "part2 solution" (part2/run puzzle-input))
  (run-tests 'advent-of-code.day4.core))
