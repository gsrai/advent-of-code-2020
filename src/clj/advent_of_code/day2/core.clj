(ns advent-of-code.day2.core
  (:require [clojure.test :refer [deftest is run-tests]]
            [advent-of-code.day2.part1 :as part1]
            [advent-of-code.day2.part2 :as part2]))

;; https://adventofcode.com/2020/day/2

(def test-passwords [[1 3 \a "abcde"]
                     [1 3 \b "cdefg"]
                     [2 9 \c "ccccccccc"]])

(def passwords [[6 10 \p "ctpppjmdpppppp"]
                [17 19 \l "llllllllllllllllllll"]
                [14 19 \z "zrzzzzzztzzzzwzzzzk"]
                [1 8 \k "qkkkkkkxkkkkkkkkk"]
                [5 6 \x "xxxxvxx"]
                [8 14 \n "nnnnnnnnnnnnkfnnnnnn"]
                [18 19 \t "ttttttttfttttttttwtt"]
                ...
                [2 5 \m "hknqmxh"]
                [12 18 \n "nnnnnnrnddjnsnnnnrnn"]
                [2 6 \r "ltgrwrrcxrrl"]
                [1 4 \l "wllllll"]
                [14 16 \t "tttttjttcttttttv"]
                [7 8 \k "bkjdmbxf"]
                [1 12 \v "vvvvvvvvvvvd"]
                [5 18 \n "nqdlvbngztlkqnshcn"]
                [7 9 \w "fwhqptwmwlkgf"]
                ...
                [5 8 \s "svfcdwss"]
                [10 19 \t "ttttwtttvttmttttttft"]
                [6 8 \h "hhhhhhhgh"]
                [5 18 \m "rcchmqmzlpptkcnhdh"]
                [1 3 \m "mmdmzxtlm"]
                [1 7 \l "lllllllbll"]
                [16 18 \t "tttttttttttttttttttt"]
                [7 9 \t "tttdjrtttkthjd"]
                ...
                [9 10 \b "bbbbbbbbbn"]
                [2 10 \j "vjgbvjlwxwts"]
                [3 11 \t "jcttqqhtdkttcnttdfx"]
                [9 10 \w "gzwwtwwwwwwwnw"]
                [12 14 \t "ttttlljzpmwrcl"]
...
;; part 1
(deftest part1-test-passwords
  (is (= (part1/validate-passwords test-passwords) 2)))

;; part 2
(deftest part2-test-passwords
  (is (= (part2/validate-passwords test-passwords) 1)))

(defn main []
  (println "part1 solution" (part1/validate-passwords passwords))
  (println "part2 solution" (part2/validate-passwords passwords))
  (run-tests 'advent-of-code.day2.core))
